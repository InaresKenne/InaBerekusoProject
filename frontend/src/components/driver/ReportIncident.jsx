...
function ReportIncident() {
  ...
  const reasonOptions = [
    { value: 'unsafe_passenger', label: 'Unsafe Passenger Behavior' },
    { value: 'rude_behavior', label: 'Rude/Disrespectful Behavior' },
    { value: 'wrong_location', label: 'Wrong Pickup/Dropoff Location' },
    { value: 'no_show', label: 'Passenger No-Show' },
    { value: 'payment_issue', label: 'Payment Issue' },
    { value: 'false_report', label: 'False Report Against Me' },
